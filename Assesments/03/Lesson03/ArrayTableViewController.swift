...
class ArrayTableViewController: UITableViewController {
    ...
    */
    ...
    // See Aardvark.swift for Animal subclass file
    
    let animalArray = [Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), Animal(name: "Sadie"), Aardvark(name: "Aarthur")]
